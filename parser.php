...
class Parser {
    ...
    private function peg_f4() {return $this->text();}
    ...
    private function peg_f12($cnt, $lag) {
       return ["pvp" => [
         "slice" => $slice
         ,"count" => $cnt
         ,"lag" => $lag
    ...
    private function peg_f13($t, $lag) {
       return ["pvp" => [
         "slice" => $slice
         ,"count" => $t
         ,"lag" => $lag
    ...
    private function peg_parseNextevent() {
      ...
      $s0 = $this->peg_currPos;
      if (mb_strtolower($this->input_substr($this->peg_currPos, 10), "UTF-8") === $this->peg_c27) {
    ...
    private function peg_parsePVPSlice() {
      ...
      $s0 = $this->peg_currPos;
      if (mb_strtolower($this->input_substr($this->peg_currPos, 3), "UTF-8") === $this->peg_c29) {
      ...
      if ($s1 !== $this->peg_FAILED) {
        ...
        if ($s2 !== $this->peg_FAILED) {
          $s3 = $this->peg_currPos;
          if (mb_strtolower($this->input_substr($this->peg_currPos, 2), "UTF-8") === $this->peg_c31) {
  ...
  public function parse($input) {
    ...
    $this->peg_c29 = "pvp";
    $this->peg_c30 = array( "type" => "literal", "value" => "pvp", "description" => "\"pvp\"" );
    $this->peg_c31 = "cl";
    $this->peg_c32 = array( "type" => "literal", "value" => "cl", "description" => "\"cl\"" );
    $this->peg_c33 = "/^[6789]/";
    $this->peg_c34 = array( "type" => "class", "value" => "[6789]", "description" => "[6789]" );
